...
import 'package:inkstryq/pages/profile/edit_profile_page.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: '/create-account', page: () => const CreateAccountScreen()),
    GetPage(
    ...
    GetPage(name: '/chat_ai', page: () => const ChatAIPage()),
    GetPage(name: '/feed-search', page: () => const FeedSearchScreen()),
